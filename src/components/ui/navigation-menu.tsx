...
const navigationMenuTriggerStyle = cva(
  "cursor-pointer group inline-flex h-9 w-max items-center justify-center rounded-md bg-background px-4 py-2 text-sm font-medium hover:bg-[#F5F5F5] hover:text-[#F5F5F5]-foreground focus:bg-[#F5F5F5] focus:text-[#F5F5F5]-foreground disabled:pointer-events-none disabled:opacity-50 data-[active=true]:bg-[#F5F5F5]/50 data-[state=open]:bg-[#F5F5F5]/50 data-[active=true]:text-[#F5F5F5]-foreground ring-ring/10 dark:ring-ring/20 dark:outline-ring/40 outline-ring/50 transition-[color,box-shadow] focus-visible:ring-4 focus-visible:outline-1",
);
