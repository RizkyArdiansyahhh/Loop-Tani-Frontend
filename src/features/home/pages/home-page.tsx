...
const HomePage = () => {
  ...
  const features = {
    marketplace: {
      ...
      badge: "Marketplace",
      description:
        "Temukan limbah pertanian berkualitas tinggi atau jual sisa panen Anda secara langsung ke pelaku industri pengolahan organik.",
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between border-b border-gray-150 pb-3 dark:border-gray-800">
            <span className="text-xs font-bold text-gray-900 dark:text-white">
              Katalog Limbah Populer
            </span>
            <span className="text-[10px] text-primary font-bold flex items-center gap-0.5 cursor-pointer">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              <div
                key={i}
                className="border border-gray-150 rounded-xl p-3 bg-white dark:border-gray-800 dark:bg-gray-950 space-y-2 shadow-3xs text-left"
              >
                ...
                <div className="space-y-1">
                  <span className="text-[9px] font-bold text-emerald-600 bg-emerald-50 dark:bg-emerald-950/30 dark:text-emerald-400 px-2 py-0.5 rounded-full">
                    {prod.label}
                  </span>
                  <h4 className="text-xs font-bold text-gray-900 dark:text-white truncate pt-1">
                    {prod.name}
                  </h4>
                  <p className="text-[10px] font-extrabold text-gray-950 dark:text-gray-300">
                    {prod.price}
                  </p>
    ...
    ai: {
      ...
      badge: "AI Assistant",
      description:
        "Konsultasi penyakit tanaman, rekomendasi pupuk limbah, hingga hitung estimasi nilai jual sisa panen Anda seketika.",
        ...
        <div className="space-y-3.5 flex flex-col h-full justify-between text-left">
          <div className="space-y-2.5">
            <div className="flex gap-2.5 items-start">
              <div className="h-7 w-7 rounded-full bg-gray-100 flex items-center justify-center font-bold text-xs shrink-0 dark:bg-gray-800">
                👤
              </div>
              <div className="bg-gray-50 border border-gray-150 rounded-xl rounded-tl-none p-2.5 text-[11px] text-gray-700 leading-relaxed dark:bg-gray-900 dark:border-gray-800 dark:text-gray-300">
                Bagaimana cara terbaik mengolah jerami padi sisa panen agar
                bermanfaat kembali?
              </div>
            </div>
            <div className="flex gap-2.5 items-start">
              <div className="h-7 w-7 rounded-full bg-emerald-500 text-white flex items-center justify-center font-bold text-xs shrink-0 select-none">
                🤖
              </div>
              <div className="bg-emerald-50/50 border border-emerald-100/60 rounded-xl rounded-tl-none p-3 text-[11px] text-emerald-950 leading-relaxed dark:bg-emerald-950/20 dark:border-emerald-900/30 dark:text-emerald-300 space-y-1">
                <p className="font-bold text-emerald-800 dark:text-emerald-400">
                  Hai! Jerami padi bisa diolah menjadi:
                </p>
                <p>1. **Kompos**: Campur dengan kotoran ternak & EM4.</p>
                <p>
                  2. **Briket/Bahan Bakar**: Potensi nilai jual Rp 1.500/kg di
                  LoopTani!
                </p>
              </div>
            </div>
    ...
    edukasi: {
      ...
      badge: "Edukasi Tani",
      description:
        "Akses ratusan modul edukasi sirkular, video praktik terverifikasi, dan kumpulkan reward LoopPoints menarik dari setiap kontribusi Anda.",
        ...
        <div className="space-y-4 text-left">
          ...
          <div className="space-y-2.5">
            {[
              ...
              <div
                key={i}
                className="flex items-center justify-between border border-gray-100 rounded-xl p-3 bg-white hover:bg-gray-50/50 dark:border-gray-800 dark:bg-gray-950/40 cursor-pointer transition-colors shadow-3xs"
              >
                <div className="flex gap-3 items-center text-left">
                  <div className="h-8 w-8 rounded-lg bg-emerald-100 dark:bg-emerald-950/50 flex items-center justify-center font-bold text-xs text-primary shrink-0 select-none">
                    📖
                  </div>
                  <div className="min-w-0">
                    <h4 className="text-xs font-bold text-gray-900 dark:text-white truncate max-w-[220px]">
                      {modul.title}
                    </h4>
                ...
                <Badge className="bg-amber-100 text-amber-800 border-0 font-extrabold text-[10px]">
                  {modul.points}
                </Badge>
              </div>
            ))}
    ...
    lestari: {
      ...
      description:
        "Hitung dan laporkan secara transparan jumlah emisi CO₂ yang berhasil dikurangi serta air tanah terlindungi dari setiap daur ulang limbah.",
      ...
      <main className="w-full bg-[#fcfdfa] dark:bg-gray-950 text-gray-900 dark:text-gray-100 overflow-hidden relative transition-colors duration-300">
        ...
        <section className="relative z-10 mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 pt-24 md:pt-32 pb-16 text-center space-y-6">
          ...
          <p className="font-sans text-xs sm:text-sm text-gray-500 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed">
            LoopTani menyatukan petani modern, industri kreatif pupuk organik,
            dan pembeli limbah pertanian secara sirkular menggunakan teknologi
          ...
          <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-2xl mx-auto mb-14 space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Pilih tab di bawah untuk melihat simulasi antarmuka dan
                kecanggihan fitur kami.
              </p>
            </div>
            ...
            <div className="flex flex-wrap p-1 rounded-xl bg-gray-50 border border-gray-150 dark:bg-gray-900 dark:border-gray-800 w-full shadow-3xs mb-8">
              {[
                {
                  key: "marketplace",
                  label: "Marketplace Sirkular",
                  icon: ShoppingBag,
                },
                {
                  key: "ai",
                  label: "AI Loopi Consultant",
                  icon: MessageSquare,
                },
              ...
              <div className="lg:col-span-5 p-8 flex flex-col justify-between text-left space-y-6">
                ...
                <div className="space-y-3.5 pt-4 border-t border-gray-100 dark:border-gray-800">
                  ...
                  <div className="pt-3">
                    <Button
                      asChild
                      className="rounded-lg bg-primary hover:bg-emerald-700 text-white font-bold text-xs h-9 cursor-pointer"
                    >
          ...
          <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-12 lg:grid-cols-3 items-center">
              <div className="lg:col-span-1 space-y-4 text-left">
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Setiap hari, para petani dan pembeli di LoopTani bergotong
                  royong mengurangi beban lingkungan dan menyuburkan ekosistem
                  pertanian kita.
                </p>
        ...
        <section className="relative z-10 mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <div className="relative border border-emerald-100/50 bg-emerald-50/10 dark:border-emerald-950/20 dark:bg-emerald-950/5 rounded-xl px-6 py-16 text-center overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl mx-auto space-y-5">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed max-w-lg mx-auto">
                Daftar sebagai mitra penjual atau pembeli sekarang. Daur ulang
                limbah organik, lindungi air tanah, dan raih LoopPoints reward
                menarik.
              </p>
