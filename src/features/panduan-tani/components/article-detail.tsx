      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 pt-6">
        ...
        <div className="mb-6">
          <Button
            variant="ghost"
            onClick={() => router.back()}
            className="inline-flex items-center gap-2 text-xs font-semibold text-muted-foreground hover:text-foreground font-poppins"
          >
        ...
        <div className="flex items-center gap-4 py-6 border-y border-gray-100 dark:border-gray-850 mb-8 font-poppins">
          <img
            src={
        ...
        {/* Article Body (Poppins Body & Paragraphs) */}
        <div className="prose prose-lg prose-emerald max-w-none text-gray-850 dark:text-gray-255 space-y-6 leading-relaxed md:leading-loose text-base md:text-lg font-poppins">
          {paragraphs.map((para, idx) => (
            <p key={idx} className="tracking-wide text-justify font-poppins">
              {para}
            </p>
          ))}
        </div>
        ...
        {/* Comments Section */}
        <div className="mt-16 border-t border-gray-100 dark:border-gray-850 pt-10 font-poppins">
            ...
            {isTrackerOpen ? (
              <div className="space-y-4">
                <div className="flex items-center justify-between border-b border-gray-50 dark:border-gray-850 pb-2">
                  <h4 className="text-xs font-bold text-gray-900 dark:text-white font-poppins">Progress Membaca</h4>
                  <button onClick={() => setIsTrackerOpen(false)} className="text-muted-foreground hover:text-foreground cursor-pointer">
                    <X className="h-4 w-4" />
                  </button>
                </div>
                
                <div className="grid grid-cols-2 gap-3 text-center font-poppins">
                ...
                <div className="pt-2 text-center font-poppins">
                  {claimed ? (
                    ...
                    <Button
                      ...
                      className="w-full py-2.5 h-auto text-xs bg-amber-500 hover:bg-amber-600 text-white font-bold rounded-xl shadow-md transition-all cursor-pointer hover:-translate-y-0.5 font-poppins"
                    >
                      Klaim {article.points} LP
                    </Button>
                  ) : (
                    <span className="text-[10px] text-muted-foreground block leading-normal font-poppins">
